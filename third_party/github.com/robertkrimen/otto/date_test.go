...
func TestDate(t *testing.T) {
	tt(t, func() {
		...
		test(`+(new Date(2009, 9, 25))`, uint64(1256428800000))
		...
		test(`new Date("2001-01-01T10:01:02.000").getTime()`, uint64(978343262000))
...
func TestDate_parse(t *testing.T) {
	tt(t, func() {
		...
		test(`Date.parse("2001-01-01T10:01:02.000")`, uint64(978343262000))

		test(`Date.parse("2006-01-02T15:04:05.000")`, uint64(1136214245000))

		test(`Date.parse("2006")`, uint64(1136073600000))
...
func TestDate_UTC(t *testing.T) {
	tt(t, func() {
		...
		test(`Date.UTC(2009, 9, 25)`, uint64(1256428800000))
...
func TestDate_setYear(t *testing.T) {
	tt(t, func() {
		...
		test(`new Date(12564504e5).setYear(96)`, uint64(846223200000))

		test(`new Date(12564504e5).setYear(1996)`, uint64(846223200000))

		test(`new Date(12564504e5).setYear(2000)`, uint64(972453600000))
	})
}
