...
// Has reports whether a top-level binding exists without triggering evaluation.
func (self Otto) Has(name string) bool {
	if self.runtime == nil || self.runtime.globalStash == nil {
		return false
	}
	return self.runtime.globalStash.hasBinding(name)
}
