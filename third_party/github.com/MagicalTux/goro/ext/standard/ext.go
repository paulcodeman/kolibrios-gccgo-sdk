...
func init() {
	phpctx.RegisterExt(&phpctx.Ext{
		...
		Functions: map[string]*phpctx.ExtFunction{
			...
			"header":                   &phpctx.ExtFunction{Func: fncHeader, Args: []*phpctx.ExtFunctionArg{}},
			"header_remove":            &phpctx.ExtFunction{Func: fncHeaderRemove, Args: []*phpctx.ExtFunctionArg{}},
			"headers_list":             &phpctx.ExtFunction{Func: fncHeadersList, Args: []*phpctx.ExtFunctionArg{}},
			"headers_sent":             &phpctx.ExtFunction{Func: fncHeadersSent, Args: []*phpctx.ExtFunctionArg{}},
			"hrtime":                   &phpctx.ExtFunction{Func: stdFuncHrTime, Args: []*phpctx.ExtFunctionArg{}},
			"http_response_code":       &phpctx.ExtFunction{Func: fncHTTPResponseCode, Args: []*phpctx.ExtFunctionArg{}},
