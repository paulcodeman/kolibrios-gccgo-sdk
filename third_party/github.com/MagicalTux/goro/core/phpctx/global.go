...
func (g *Global) Tick(ctx phpv.Context, l *phpv.Loc) error {
	...
	g.deadlineCheckBudget = deadlineCheckPeriod - 1
	if kos.UptimeNanoseconds() >= g.deadlineMonotonicNS {
