...
func (p Point52_12) Div(k Int52_12) Point52_12 {
	return Point52_12{
		Int52_12(divInt64(int64(p.X)*4096, int64(k))),
		Int52_12(divInt64(int64(p.Y)*4096, int64(k))),
	}
}
...
func divInt64(n int64, d int64) int64 {
	if d == 0 {
		return 0
	}
	neg := (n < 0) != (d < 0)
...
func udiv64(n uint64, d uint64) uint64 {
	if d == 0 {
		return 0
	}
	var q uint64
