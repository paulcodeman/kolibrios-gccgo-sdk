...
func (element *Element) resolvedWidthWithContext(ctx LayoutContext, style Style) int {
	...
	baseWidth = element.measureWidthWithSpec(ctx, ctx.Viewport, style, text, font, charWidth, lineHeight, textWidth, baseWidth)
...
func (element *Element) resolvedHeightInWithContext(ctx LayoutContext, style Style, container Rect) int {
	...
	if text != "" {
		...
		baseHeight = element.measureHeightWithSpec(ctx, container, style, text, font, charWidth, lineHeight, textWidth, textHeight, baseHeight)
