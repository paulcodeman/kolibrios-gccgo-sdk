...
func Run() {
	...
	documentRoot := ui.NewDocumentElement("root", style(func(value *ui.Style) {
		...
		value.SetFontSize(13)
		value.SetMargin(0, 0, 6, 0)
	})), incrementCard, resetCard, accentCard, detailsToggleCard, outlineCard, detailsCard, styleLabTitle, borderLab, boxBorderBox, boxContentBox, textLab, visibilityBefore, visibilityHidden, visibilityAfter, notes)
